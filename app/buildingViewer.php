...
<body>
    ...
    <div class="container map-creator">
        <div class="row">
			...
			$query = "SELECT * FROM Buildings WHERE userName = 'TestingCm';";
                            ...
                            echo "<a href='newMap.php?building=".$row["id"]."'>[+]</a>";
                                ...
                                if(mysqli_num_rows($floors) > 0) {
                                    while($j = mysqli_fetch_array($floors)){
                                        echo "<div class='floorclass'><a href='routeBuilder.php?floor=".$j['fileName']."'><img src='/uploads/".$j["fileName"]."' height=300 width=300> </a></div><br>";
