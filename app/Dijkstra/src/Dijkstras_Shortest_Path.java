...
public class Dijkstras_Shortest_Path
{
    ...
    public Dijkstras_Shortest_Path(int number_of_nodes)
    {
        ...
        mypath = new int[1000001][number_of_nodes + 1];
        this.xx = xx;
    }
    ...
    public static int[][] read() throws IOException {
        ...
        BufferedReader bf = new BufferedReader(new FileReader("/var/www/html/Indoor_Navigation_Server/app/read.txt"));
    ...
    private static void write(String print) throws IOException {
        PrintWriter pw =  new  PrintWriter(  new  FileWriter(  "/var/www/html/Indoor_Navigation_Server/app/write.txt"  ) );
        pw.print(print);
        pw.close();
    ...
    public static void find(int[] buf, int a, int b) {
        if (a == b) {
            for (int i = 1; i < b; i++) {
                ...
                //System.out.print(mypath[flag_path][i]);
            }
            //System.out.println();
            flag_path++;
            //System.out.println();
